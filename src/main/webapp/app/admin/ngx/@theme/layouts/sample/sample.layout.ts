    ...
    template: `
        <nb-layout [center]="layout.id === 'center-column'" windowMode>
            <nb-layout-header fixed>
                <jhi-ngx-header [position]="sidebar.id === 'start' ? 'normal' : 'inverse'"></jhi-ngx-header>
            </nb-layout-header>
            ...
            <nb-layout-footer fixed> <jhi-ngx-footer></jhi-ngx-footer> </nb-layout-footer>
        ...
        <jhi-ngx-toggle-settings-button></jhi-ngx-toggle-settings-button>
    `
})
