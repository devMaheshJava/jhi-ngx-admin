...
@Component({
    selector: 'jhi-ngx-country-orders',
    ...
    template: `
        <nb-card [size]="breakpoint.width >= breakpoints.md ? 'medium' : 'xxlarge'">
            ...
            <nb-card-body>
                <jhi-ngx-country-orders-map (select)="selectCountryById($event)" countryId="USA"> </jhi-ngx-country-orders-map>
                <jhi-ngx-country-orders-chart [countryName]="countryName" [data]="countryData" [labels]="countriesCategories" maxValue="20">
                </jhi-ngx-country-orders-chart>
            </nb-card-body>
        </nb-card>
    `
})
